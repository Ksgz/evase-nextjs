...
export default class html extends React.Component {
    ...
    renderChildPage(childPage, index) {
        ...
        return (
            <li key={index} className="html-section-item">
                <Link href={childPageUrl} className="html-item-link">
                    {childPageTitle}
    ...
    render() {
        ...
        const childPages = _.orderBy(getPages(html, pageUrl), 'weight');
            ...
            <Layout page={page} config={config}>
                <div className="inner outer">
                    <div className="html-content">
                        <htmlMenu page={page} htmlConfig={htmlConfig} html={html} />
                        <article className="post type-html">
                            <div className="post-inside">
                                ...
                                <div className="post-content" ref={this.pageContent}>
                                    ...
                                    {htmlRootPath !== pageUrl && !_.isEmpty(childPages) && (
                                        <ul id="html-section-items" className="html-section-items">
